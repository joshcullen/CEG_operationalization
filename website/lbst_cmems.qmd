...
status <- sapply(meta_df$product,
                 \(x) check_cmems(path_copernicus_marine_toolbox = "C:\\Miniconda\\envs\\test\\Scripts\\copernicusmarine.exe",
...
This example shows both model predictions and environmental covariates used to estimate the models. Change the date and selected variable to explore these relationships in more detail. Layers are available starting from **`r prod_dates$date[1]`**.
...
<div>
  ...
  <input type="date" id="start-date" name="start-date" min="2025-06-22">
  
  <label for="end-date">End Date:</label>
  <input type="date" id="end-date" name="end-date" min="2025-06-22">
...
async function fetchLatestDateFromGitHub() {
  ...
  return {
    minDate: '2025-06-22', // Fixed known earliest date
